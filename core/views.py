...
from .models import (
    ...
    UserProfile, UserLike, CATEGORY_CHOICES
)
...
class CategoryView(View):
    def get(self, request, category, *args, **kwargs):
        ...
        if category.upper() not in valid_categories:
            ...
            items = Item.objects.filter(category=category.upper())
            selected_category = dict(CATEGORY_CHOICES).get(category.upper())
        return render(request, 'category.html', {'items': items, 'selected_category': selected_category})
